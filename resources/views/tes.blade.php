...
<head>
    ...
    <link href="/admingym/vendor/wow-master/css/libs/animate.css" rel="stylesheet">
    <link href="/admingym/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/admingym/vendor/bootstrap-select-country/css/bootstrap-select-country.min.css">
    <link rel="stylesheet" href="/admingym/vendor/jquery-nice-select/css/nice-select.css">
    <link href="vendor/datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">

    <link href="/admingym/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <!--swiper-slider-->
                    ...
                    <div class="card bg-transparent mb-1">
                        ...
                        <div class="card-footer text-center border-0 pt-0 px-3 pb-0">
                            <a href="javascript:void(0);"
                                ...
                                rel="ajax/recentactivity.html">View More</a>
                        </div>
                    </div>
                </div>
                <!--/column-->
                                ...
                                <table id="example-1" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="./images/trans/1.jpg" alt=""
                                        ...
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="./images/trans/2.jpg" alt=""
                                                        class="avatar avatar-sm me-3">
                                                    <h4>Tony Soap</h4>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="./images/trans/3.jpg" alt=""
                                                        class="avatar avatar-sm me-3">
                                                    <h4>Jordan Nico</h4>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="./images/trans/4.jpg" alt=""
                                                        class="avatar avatar-sm me-3">
                                                    <h4>Karen Hope</h4>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="./images/trans/5.jpg" alt=""
                                                        class="avatar avatar-sm me-3">
                                                    <h4>Nadila Adja</h4>
                                                </div>
                                            </td>
